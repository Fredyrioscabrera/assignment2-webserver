  ...
  while True:
    ...
    try:
      ...
      #Fill in start - append your html file contents #Fill in end 
        final_response = header.encode() + outputdata   
      ...
      #Fill in start
        ...
        error_header += "Content-Type: text/html\r\n"
      ...
      #Close client socket
      #Fill in start
        connectionSocket.send(error_header.encode() + error_content.encode())
      #Fill in end
